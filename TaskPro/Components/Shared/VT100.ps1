...
class VT {
    ...
    # Basic colors for component compatibility (CommandLibrary/TimeTracker)
    static [string] Red() { return "`e[91m" }      # Bright red
    static [string] Green() { return "`e[92m" }    # Bright green  
    static [string] Yellow() { return "`e[93m" }   # Bright yellow
    static [string] Blue() { return "`e[94m" }     # Bright blue
    static [string] Magenta() { return "`e[95m" }  # Bright magenta
    static [string] Cyan() { return "`e[96m" }     # Bright cyan
    static [string] White() { return "`e[97m" }    # Bright white
    static [string] Gray() { return "`e[90m" }     # Dark gray
    static [string] Reverse() { return "`e[7m" }   # Reverse video
    ...
    # Box compatibility methods for CommandLibrary/TimeTracker
