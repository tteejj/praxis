    ...
    [void] ShowFindReplaceDialog() {
        try {
            ...
            $findDialog.OnClose = {
                ...
                $focusManager = $editor.ServiceContainer.GetService('FocusManager')
                if ($focusManager) {
...
"@
    ...
    hidden [void] RenderWithCache([System.Text.StringBuilder]$sb) {
        ...
        $bgColor = $this.ThemeManager.GetBgColor('surface.background')
        ...
        $statusColor = $this.ThemeManager.GetColor('status.info')
        $statusBgColor = $this.ThemeManager.GetBgColor('status.info')
    ...
    hidden [string] RenderLine([int]$lineNumber, [int]$lineNumberWidth, [int]$textWidth) {
        ...
        # Get colors
        $textColor = $this.ThemeManager.GetColor('text.primary')
        $lineNumColor = $this.ThemeManager.GetColor('text.secondary')
        $bgColor = $this.ThemeManager.GetBgColor('surface.background')
        $selectionBgColor = $this.ThemeManager.GetBgColor('state.selected')
        $selectionTextColor = $this.ThemeManager.GetColor('text.primary')
    ...
    hidden [void] RenderCursor([System.Text.StringBuilder]$sb, [int]$lineNumWidth, [int]$editorHeight) {
        ...
        # Get colors
        $cursorBgColor = $this.ThemeManager.GetBgColor('state.focused')
        $cursorTextColor = $this.ThemeManager.GetColor('focus.reverse.text')
        ...
        # Reset colors
        $resetColor = $this.ThemeManager.GetColor('text.primary')
