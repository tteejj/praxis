...
class ConfirmationDialog : BaseDialog {
    ...
    [void] OnActivated() {
        ...
        # Override to focus on cancel button by default (safer for confirmations)
        $focusManager = $this.ServiceContainer.GetService('FocusManager')
        if ($focusManager -and $this.SecondaryButton) {
            $focusManager.SetFocus($this.SecondaryButton)
        } elseif ($this.SecondaryButton) {
