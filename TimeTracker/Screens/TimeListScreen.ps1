    ...
    [void] RenderTimeList([System.Text.StringBuilder]$sb) {
        ...
        foreach ($i in $visibleItems) {
            ...
            if ($isSelected) {
                ...
                $this.RenderTimeContent($sb, $entry, $false, $false)  # Keep description for proper alignment
                ...
                # Skip the dedicated description line since it's already in the main content
                # This prevents duplication while maintaining proper column alignment
